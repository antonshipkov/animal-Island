...
public class WolfDrawer implements Drawer<Wolf> {
    ...
    private static final com.typesafe.config.Config CONF = Configuration.ROOT.getConfig("wolf.draw");
    ...
    static {
        try {
            URL resource = Wolf.class.getClassLoader().getResource( "resources/wolf.png" );
